...
import Flake from '@/assets/newsletter-flake.svg'

export default function Newsletter() {
    return (
        <section>
            <div className="max-w-7xl mx-auto px-4 lg:px-8 xl:px-16 md:py-20 py-8">
                <div className="bg-teal-400/20 py-24 relative overflow-hidden">
                    <Image src={Flake} alt="newsletter-flake" width={320} height={320} className="absolute animate-spin [animation-duration:3000ms] w-80 h-80 -top-2/4 right-0 -z-1" />
                    ...
                    <Image src={Flake} alt="newsletter-flake" width={320} height={320} className="absolute animate-spin [animation-duration:3500ms] top-1/3 -z-1" />
                </div>
            </div>
        </section>
    );
