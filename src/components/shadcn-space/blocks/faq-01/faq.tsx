...
const FAQ_DATA = [
  {
    ...
    answer:
      "We provide interactive classes on JavaScript, React, Next.js, TypeScript, MERN, and PERN stack.",
  },
  {
    question: "Do I need prior coding experience?",
    answer:
      "Not at all! Our courses are built to take you from absolute beginner to job-ready software engineer.",
  },
  {
    question: "Is there a free trial option available?",
    answer:
      "Yes, you can register and try our introductory programming labs for free.",
  },
  {
    question: "Do you offer job placement support?",
    answer:
      "Yes! We provide comprehensive resume builders, career coaching sessions, mock interview prep, and direct job placement assistance. Once you enroll in our Bootcamp tier, you get direct access to our hiring network, career coaches, and recruitment partners for free.",
  },
  {
    question: "Can I learn AI development here?",
    answer:
      "Absolutely! We offer specialized courses on building AI agents, using OpenAI APIs, and integrating machine learning tools in web applications.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:py-24 py-8 flex flex-col gap-16">
        <div className="flex flex-col gap-4 items-center animate-in fade-in slide-in-from-top-10 duration-1000 delay-100 ease-in-out fill-mode-both">
          ...
          <h2 className="text-5xl font-medium text-center max-w-lg">
            Got questions? We have answers ready
          </h2>
        </div>
        <div>
