            ...
            >
              <div className="flex flex-col gap-3 items-center text-center">
                ...
                <p className="max-w-2xl mx-auto">
                  Ready to start coding? We provide interactive, AI-assisted coding courses that train and help you land junior software developer positions.
                </p>
              </div>
