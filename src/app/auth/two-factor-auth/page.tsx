                  ...
                  <Field className="gap-6 w-full mt-4">
                    <FieldDescription className="text-center text-sm font-normal text-muted-foreground">
                      ...
                      <button
                        ...
                        className="font-medium text-card-foreground no-underline hover:underline cursor-pointer"
                      >
                        Resend code
                      </button>
                    </FieldDescription>
                    ...
                    <Link href="/auth/login" className="block text-center text-sm underline mt-2 w-full">
                      Back to Login
                    </Link>
                  </Field>
                </div>
