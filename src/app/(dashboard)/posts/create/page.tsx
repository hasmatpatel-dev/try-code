    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight text-white">Create New Article</h1>
            <p className="text-xs text-gray-500">Draft your content and configure publishing options.</p>
          </div>
        </div>
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <input
                          type="checkbox"
                          className="rounded border-[#161C2C] bg-gray-950 text-purple-600 focus:ring-purple-500/20"
                          checked={field.value.includes(tg.id)}
                          onChange={(e) => {
                            if (e.target.checked) {
