...
export default function PostContent({ post, relatedPosts }: PostContentProps) {
  ...
  return (
    <div className="relative min-h-screen bg-[#030712] text-gray-100 py-16 px-4 sm:px-6 lg:px-8">
      <div className="absolute top-0 left-1/3 h-[400px] w-[400px] rounded-full bg-purple-950/5 blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto space-y-10 relative">
        ...
        <div className="flex items-center justify-between border-b border-[#161C2C] pb-6">
          ...
          <div className="text-xs text-gray-500 flex items-center space-x-2">
            ...
            <span className="text-purple-400 font-semibold truncate max-w-[150px]">{post.title}</span>
          </div>
        </div>
        ...
        <div className="grid gap-10 lg:grid-cols-4 items-start">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                {post.categories?.map((c: any) => (
                  <span
                    key={c.id}
                    className="text-xs font-semibold bg-purple-500/10 border border-purple-500/20 text-purple-400 px-2.5 py-0.5 rounded-full"
                  >
                    {c.name}
                  </span>
                ))}
              ...
              <div className="flex flex-wrap items-center gap-4 text-xs text-gray-500 pt-2 border-y border-[#161C2C]/50 py-3">
            ...
            {/* Cover Image */}
            {post.coverImage && (
              <div className="aspect-video w-full rounded-2xl border border-[#161C2C] overflow-hidden bg-gray-950">
            ...
            <div className="rounded-2xl border border-[#161C2C] bg-[#090D1A]/50 p-6 shadow-xl backdrop-blur-xl space-y-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 flex items-center justify-center p-2 rounded-xl bg-gray-950 border border-[#161C2C] text-gray-400 hover:text-white hover:bg-gray-900 transition"
